          ...
          {paymentMethods.map((method) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex flex-col items-center gap-3 rounded-xl border-2 bg-card p-6 transition-all active:scale-[0.97]",
